...
import youtube.playlists.handler
from youtube.playlists.auth.models import User


class LoginHandler(youtube.playlists.handler.Handler,
...
class LogoutHandler(youtube.playlists.handler.Handler):
    def get(self):
